...
namespace GlslWallpaper.Win32
{
    ...
    /// To assign a style to a window class, assign the style to the style member of the <see cref="WndClassEx"/> structure.
    /// </summary>
    /// <remarks>
    /// <seealso href="https://learn.microsoft.com/en-us/windows/win32/winmsg/window-class-styles"/>
    /// </remarks>
    [Flags]
    public enum WindowClassStyleFlags
    {
        /// <summary>
        ...
        NoClose = 0x0200,
        /// <summary>
        /// <para>Saves, as a bitmap, the portion of the screen image obscured by a window of this class.
        ...
        /// Therefore, the system does not send <see href="https://learn.microsoft.com/en-us/windows/win32/gdi/wm-paint">WM_PAINT</see> messages to windows that were obscured
        /// if the memory used by the bitmap has not been discarded and if other screen actions have not invalidated the stored image.</para>
        /// <para>This style is useful for small windows (for example, menus or dialog boxes) that are displayed briefly and then removed before other screen activity takes place.
        /// This style increases the time required to display the window, because the system must first allocate memory to store the bitmap.</para>
        /// </summary>
        SaveBits = 0x0800,
        /// <summary>
        ...
        /// For more information, see the "Application Global Classes" section of <see href="https://learn.microsoft.com/en-us/windows/win32/winmsg/about-window-classes">About Window Classes</see>.
        /// </summary>
        GlobalClass = 0x4000,
        /// <summary>
