...
namespace GlslWallpaper.Win32
{
    ...
    {
        /// <summary>
        /// Set up the PixelFormat for OpenGL.
        /// </summary>
        /// <param name="dcHandle">Device context.</param>
        /// <returns>Index of pixel format.</returns>
        ...
        /// </summary>
        /// <param name="dcHandle">Specifies the device context that the function examines to determine the best match for the pixel format descriptor pointed to by <paramref name="pfd"/>.</param>
        ...
        /// </summary>
        /// <param name="dcHandle">Specifies the device context whose pixel format the function attempts to set.</param>
        /// <param name="format">Index that identifies the pixel format to set.</param>
        /// <param name="pfd">Pointer to a <see cref="PixelFormatDescriptor"/> structure that contains the logical pixel format specification.</param>
...
#endif  // SUPPORT_LIBRARY_IMPORT
        {
            ...
            /// <summary>
            /// The <see cref="SwapBuffers"/> function exchanges the front and back buffers if the current pixel format
