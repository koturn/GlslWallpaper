...
namespace GlslWallpaper.Win32
{
...
#endif  // SUPPORT_LIBRARY_IMPORT
    {
        ...
        /// </summary>
        /// <returns>Monitor information list.</returns>
        ...
        /// </summary>
        /// <param name="hWnd">Window handles associated with the device context.</param>
        ...
        /// <summary>
        /// Register window class with default window procedure.
        /// </summary>
        /// <param name="className">Window class name.</param>
        /// <returns><see cref="ClassAtom"/> instance.</returns>
        ...
        /// <summary>
        /// Creates a window that covers the specified monitor area.
        /// </summary>
        /// <param name="name">Window class name.</param>
        /// <param name="rect">A rectangular area covering the entire monitor.</param>
        /// <param name="hWndParent">Parent window handle.</param>
        /// <returns><see cref="NativeWindowHandle"/> instance.</returns>
        public static NativeWindowHandle CreateMonitorWindow(string name, Rect rect, nint hWndParent = default)
        {
            unsafe
            {
        ...
        /// Creates a window that covers the specified monitor area.
        /// </summary>
        /// <param name="atom">Class atom.</param>
        /// <param name="rect">A rectangular area covering the entire monitor.</param>
        /// <param name="hWndParent">Parent window handle.</param>
        /// <returns><see cref="NativeWindowHandle"/> instance.</returns>
        public static NativeWindowHandle CreateMonitorWindow(ClassAtom atom, Rect rect, nint hWndParent = default)
        {
            var hWnd = SafeNativeMethods.CreateWindowEx(
                ExtendedWindowStyleFlags.Left,
                atom.Handle,
        ...
        /// </summary>
        /// <param name="hWnd">A handle to the window to destroy.</param>
        ...
        private static nint WndProcDefault(nint hWnd, uint uMsg, nint wParam, nint lParam)
        {
            switch (uMsg)
            {
            ...
            return SafeNativeMethods.DefWindowProc(hWnd, uMsg, wParam, lParam);
        }
