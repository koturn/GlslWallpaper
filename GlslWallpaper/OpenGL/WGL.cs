...
namespace GlslWallpaper.OpenGL
{
...
#endif  // SUPPORT_LIBRARY_IMPORT
    {
        ...
        /// <summary>
        /// Delegate for <see href="https://registry.khronos.org/OpenGL/extensions/ARB/WGL_ARB_create_context.txt"><c>wglCreateContextAttribsARB</c></see>.
        /// </summary>
        /// <param name="hdc">Handle to a device context.</param>
        /// <param name="share">all shareable data (excluding OpenGL texture objects named 0) will be shared by <paramref name="share"/>
        /// all other contexts <paramref name="share"/> already shares with, and the newly created context.</param>
        /// <param name="attribs">
        /// list of attributes for the context.
        /// The list consists of a sequence of &lt;name,value&gt; pairs terminated by the value 0.
        /// If an attribute is not specified in <paramref name="attribs"/>, then the default value specified below is used instead.
        /// If an attribute is specified more than once, then the last value specified is used.
        /// </param>
        /// <returns>Created OpenGL rendering context</returns>
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private unsafe delegate nint WGLCreateContextAttribsARBFunc(nint hdc, nint share, int* attribs);
        /// <summary>
        /// Delegate for <see href="https://registry.khronos.org/OpenGL/extensions/EXT/WGL_EXT_swap_control.txt"><c>wglSwapIntervalEXT</c></see>.
        /// </summary>
        /// <param name="frameCount">The minimum number of video frames that are displayed before a buffer swap will occur.</param>
        /// <returns>
        ...
        /// </returns>
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate bool WGLSwapIntervalEXTFunc(int frameCount);
#endif  // DISABLE_FUNCTION_POINTER

        /// <summary>
        /// Module handle of oepngl32.dll
        /// </summary>
        private static nint hOpengl32;
#if DISABLE_FUNCTION_POINTER
        /// <summary>
        /// The instance of the <see cref="WGLCreateContextAttribsARBFunc"/>
        /// which is the delegate for <see href="https://registry.khronos.org/OpenGL/extensions/ARB/WGL_ARB_create_context.txt"><c>wglCreateContextAttribsARB</c></see>.
        /// </summary>
        private static WGLCreateContextAttribsARBFunc? _wglCreateContextAttribsARB;
        /// <summary>
        /// The instance of the <see cref="WGLSwapIntervalEXTFunc"/>
        /// which is the delegate for <see href="https://registry.khronos.org/OpenGL/extensions/EXT/WGL_EXT_swap_control.txt"><c>wglSwapIntervalEXT</c></see>.
        /// </summary>
        ...
        /// </remarks>
        private static unsafe delegate* unmanaged[Cdecl]<nint, nint, int*, nint> _wglCreateContextAttribsARB;
        /// <summary>
        ...
        /// </summary>
        private static unsafe delegate* unmanaged[Cdecl]<int, bool> _wglSwapIntervalEXT;
#endif  // DISABLE_FUNCTION_POINTER

        /// <summary>
        /// Creates a new OpenGL rendering context, which is suitable for drawing on the device referenced by <paramref name="dcHandle"/>.
        /// </summary>
        ...
        /// <summary>
        /// Creates a new extended OpenGL rendering context, which is suitable for drawing on the device referenced by <paramref name="dcHandle"/>.
        /// </summary>
        /// <param name="dcHandle">Device context.</param>
        /// <param name="glrcShareHandle">All shareable data (excluding OpenGL texture objects named 0) will be shared by <paramref name="glrcShareHandle"/>,
        /// all other contexts <paramref name="glrcShareHandle"/> already shares with, and the newly created context. </param>
        /// <param name="attribs">
        /// list of attributes for the context.
        /// The list consists of a sequence of &lt;name,value&gt; pairs terminated by the value 0.
        /// If an attribute is not specified in <paramref name="attribs"/>, then the default value specified below is used instead.
        ...
        /// </param>
        /// <returns>A new OpenGL rendering context.</returns>
        public static GLRenderContextHandle CreateContextAttribsARB(DeviceContextHandle dcHandle, GLRenderContextHandle? glrcShareHandle, int[] attribs)
        {
            unsafe
            {
            ...
            unsafe
            {
                ...
                {
                    var hGlRc = _wglCreateContextAttribsARB(
                        dcHandle.DangerousGetHandle(),
                        glrcShareHandle == null ? default : glrcShareHandle.DangerousGetHandle(),
                        pAttribs);
                    if (hGlRc == 0)
                    {
        ...
        /// The interval takes effect when <see cref="Gdi32.SwapBuffers(DeviceContextHandle)"/> or wglSwapLayerBuffer is first called subsequent to the <see cref="SwapInterval(int)"/> call.
        /// </summary>
        /// <param name="frameCount">The minimum number of video frames that are displayed before a buffer swap will occur.</param>
        ...
        /// <summary>
        /// Releases the current rendering context of the calling thread.
        /// </summary>
        /// <param name="ignoreError">True to ignore error; not throw exception.</param>
        ...
        /// The <paramref name="glrcHandleTo"/> parameter should not contain any existing display lists when <see cref="ShareLists(GLRenderContextHandle, GLRenderContextHandle)"/> is called.</param>
