namespace GlslWallpaper.OpenGL
{
    ...
    {
        /// <summary>
        /// Lists is treated as an array of bytes, each in the range -128 through 127.
        /// </summary>
        Byte = 0x1400,
        /// <summary>
        ...
        UnsignedByte = 0x1401,
        /// <summary>
        /// Lists is treated as an array of two-byte integers, each in the range -32768 through 32767.
        /// </summary>
        Short = 0x1402,
        /// <summary>
        ...
        /// <summary>
        /// Lists is treated as an array of four-byte integers, each in the range -2147483648 through 2147483647.
        /// </summary>
        Int = 0x1404,
        /// <summary>
