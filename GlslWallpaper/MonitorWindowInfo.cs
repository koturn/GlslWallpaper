...
using GlslWallpaper.Internals.Extensions;
...
namespace GlslWallpaper
{
    ...
    public sealed class MonitorWindowInfo : IDisposable
    {
        ...
        {
            get => _textBoxShaderSource.Dispatcher.InvokeFuncIfNeeded(() => _textBoxShaderSource.Text);
            set => _textBoxShaderSource.Dispatcher.InvokeIfNeeded(() => _textBoxShaderSource.Text = value);
        }
        /// <summary>
        ...
        /// <summary>
        /// <see cref="TextBox"/> to hold shader source path.
        /// </summary>
        private readonly TextBox _textBoxShaderSource;
        ...
        /// <param name="textBoxShaderSource"><see cref="TextBox"/> to hold shader source path.</param>
        public MonitorWindowInfo(NativeWindowHandle windowHandle, Rect rect, string deviceName, TextBox textBoxShaderSource)
        {
            WindowHandle = windowHandle;
            Rect = rect;
            DeviceName = deviceName;
            _textBoxShaderSource = textBoxShaderSource;
            ...
            UpdateRenderContext([
                WGLContext.MajorVersionARB, major,
                WGLContext.MinorVersionARB, minor,
                WGLContext.ProfileMaskARB, WGLContext.CoreProfileBitARB,
                0
            ]);
        }
        ...
        public MonitorWindowInfo(NativeWindowHandle windowHandle, Rect rect, string deviceName, TextBox textBoxShaderSource, int[] attribs)
        {
            WindowHandle = windowHandle;
            Rect = rect;
            DeviceName = deviceName;
        ...
        /// </summary>
        /// <param name="attribs">Attribute array for <see cref="WGL.CreateContextAttribsARB(DeviceContextHandle, GLRenderContextHandle, int[])"/>.</param>
        public void UpdateRenderContext(int[] attribs)
        {
            ...
            RenderContextHandle = WGL.CreateContextAttribsARB(DeviceContextHandle, null, attribs);
